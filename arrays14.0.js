...
var data =rs.question('Digite uma data')
...
var mes = data.match(/\/\d{2}\//).toString().replace(/\//g,"")  // o "\" significa que quero dar um comando, tive que usar o metodo toString para forcar ser um objeto string para poder ter acesso ao metodo replace, no replace usei a letra "g" que significa global para poder substituir as duas "//" em uma unica vez.
